...
(defn booker-start [booking-available-from]
...
(defn flight-input [{:keys [testid value disabled flight-change!]}]
  [:div.field
...
(defn book-button [booker booking-available-from booking-message!]
...
(defn reset-booker-msg! [*booker _]
  (swap! *booker assoc :booker-msg nil))

(defn book-message [{:keys [booker-msg]} reset-booker-msg!]
  (when booker-msg
