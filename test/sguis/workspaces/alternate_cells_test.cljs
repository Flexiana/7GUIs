...
(ws/deftest
  ...
  (are [expected actual] (= expected actual)
    ...
    4 (eval-cell (new-table {:A1 "2"
                             :A2 "= Add(A1,2)"}) "A2")
    9 (eval-cell (new-table {:A0 "= sum(A1:A9)"
                             :A1 "1"
                             :A2 "1"
                             :A3 "1"
                             :A4 "1"
    ...
    10 (eval-cell (new-table {:A0 "1"
                              ...
                              :A9 "A1"
                              :B0 "= sum (A0:A9)"}) "B0")
    "Cyclic dependency found A0" (eval-cell (new-table {:A0 "A0"}) "A0")
    "" (eval-cell (new-table {}) "Div of B5 and C5 =")
    ...
    "Cyclic dependency found A1" (eval-cell {:chain #{}
